...
After the first deploy, the database has empty tables. Load the full catalog (currently 42 courses / 126 modules / 467 lessons combined) via the admin endpoint:
