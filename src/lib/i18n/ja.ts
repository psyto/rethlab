...
export const ja: TranslationKeys = {
  ...
  page: {
    ...
    tracks: {
      title: '4 段階・8 コース: ソースを読み、そして作る',
      subtitle: '4 段階すべて修了すれば、Paradigm・Hyperliquid・Tempo が使う Rust EVM スタックを読み・拡張し・リリースできる。Expert 段階は理解だけでなく、動くアプリを ship して終わる。',
      basicsDesc: 'Rust EVM スタックがなぜ重要か、環境構築、そして実際の RPC に接続する最初の Alloy スクリプト。',
      fundamentals: 'ファンダメンタルズ',
      fundamentalsDesc: '2 コース: Fundamentals（Alloy の型・Provider・署名、Revm を読む前に必要な EVM 概念 — スタック・メモリ・Opcode・ガス）と Bridge to Advanced（EVM をバイト単位で — dispatch loop・ワールドステート・コールフレーム・reorg — に加え中級 Rust: generics・?Sized・dyn・Arc・unsafe・マクロ）。Solidity 主体の開発者が Advanced で当たるギャップを埋める。',
      hyperliquid: '上級',
      hyperliquidDesc: '独立した 3 つのソース読解コース（任意の順で受講可): Alloy（Provider/Network/Signer チェーン)、Revm（インタープリター内部、カスタム Opcode、Database トレイト)、Reth（Staged Sync、Execution Extensions、Reth SDK)。',
      expertDesc: '2 コース。Expert: パフォーマンスエンジニアリング、MDBX、Tokio 内部、手続きマクロ、カスタム Precompile、MPT、本番 MEV、zkEVM、独自 Reth フォーク運用。Building with the Stack: 動くアプリ 8 本 — MEV searcher、reorg-aware indexer、カスタム RPC、wallet backend、EIP-7702 sponsor、Foundry スタイル cheatcode、swap aggregator、そして frontrun-resistant order router の capstone。',
      hlDev: 'Reth開発者',
