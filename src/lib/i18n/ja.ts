...
export const ja: TranslationKeys = {
  ...
  about: {
    title: 'RethLabについて',
    subtitle: 'Hyperliquid が動いている基盤。Tempo がローンチした基盤。Paradigm が build した — Reth・Revm・Foundry・Alloy。Rust EVM スタックは今クリプトインフラで瞬間を迎えていて、それを読めるエンジニアはまだ希少です。RethLab は 13 コース 4 ティアで、Rust EVM の基礎・本番ソースの行単位読解・L1 アーキテクチャ設計・9 本の動くアプリ開発までを通すトレーニングプログラムです。',
  ...
  page: {
    ...
    tracks: {
      ...
      subtitle: '4 ティアすべて修了すれば、Paradigm・Hyperliquid・Tempo が使う Rust EVM スタックを読み、設計し、運用できる。',
