export const en = {
  ...
  page: {
    ...
    tracks: {
      title: '8 Courses Across 4 Tiers: Read the Source, Then Build',
      subtitle: 'Finish all four tiers and you can read, extend, AND ship the Rust EVM stack used by Paradigm, Hyperliquid, and Tempo. The Expert tier ends with you shipping a working app — not just understanding code.',
      basicsDesc: 'Why the Rust EVM stack matters, environment setup, and your first Alloy script that hits a real RPC.',
      fundamentals: 'Fundamentals',
      fundamentalsDesc: 'Two courses: Fundamentals (Alloy types, providers, signing, EVM concepts — stack, memory, opcodes, gas) and Bridge to Advanced (EVM at the bytes level — dispatch loop, world state, call frames, reorgs — plus intermediate Rust: generics, ?Sized, dyn, Arc, unsafe, macros). Closes the gap Solidity-native devs hit when they reach Advanced.',
      hyperliquid: 'Advanced',
      hyperliquidDesc: 'Three independent source-walking courses (take in any order): Alloy (Provider/Network/Signer chains), Revm (interpreter internals, custom opcodes, Database trait), and Reth (Staged Sync, Execution Extensions, Reth SDK).',
      expertDesc: 'Two courses. Expert: performance engineering, MDBX, Tokio internals, procedural macros, custom precompiles, MPT, MEV pipelines, zkEVM, and a custom Reth fork. Building with the Stack: eight runnable apps — MEV searcher, reorg-aware indexer, custom RPC, wallet backend, EIP-7702 sponsor, Foundry-style cheatcode, swap aggregator, and a frontrun-resistant order router capstone.',
      hlDev: 'Reth Devs',
