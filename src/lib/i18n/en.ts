export const en = {
  ...
  courses: {
    ...
    catalog: {
      ...
      subtitle: 'From beginner to expert across 4 tiers (foundations, source-reading of Reth / Revm / Alloy, L1 architecture, production apps), plus DIY Perp — a 4-course build-along where you construct your own open-source Hyperliquid implementation from scratch.',
    ...
    diyPerpSeries: {
      ...
      mapping: 'The DIY Perp series is the build-along course track for openhl. You start from `cargo init` on an empty directory and reach a runnable open-source Hyperliquid implementation over four courses — Consensus → CLOB → Precompiles → Funding — with openhl pinned to specific commit SHAs as the byte-identical answer key for each lesson.',
  ...
  page: {
    ...
    tracks: {
      ...
      diyPerpDesc: 'Build your own open-source Hyperliquid implementation (perpetual DEX) from scratch. Four build-along courses cover consensus, the CLOB matching engine, custom EVM precompiles, and the funding state machine — each lesson diffed against `psyto/openhl` as the answer key.',
      diyPerpTag: 'Project',
      hlDev: 'Reth Devs',
