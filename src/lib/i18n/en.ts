export const en = {
  ...
  about: {
    ...
    background: {
      ...
      multilingual: 'Global',
      multilingualDetail: '2 yrs Hong Kong (internet startup, 500K+ users), 2 yrs Bangalore (offshore QA lead at iGate), 15+ yrs Tokyo (financial institutions). Bilingual EN / JA — RethLab content shipped at full parity.',
    },
    tech: {
